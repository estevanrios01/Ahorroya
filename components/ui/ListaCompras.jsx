...
export default function ListaCompras() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-[#0f172a] border-l border-slate-800 h-full flex flex-col shadow-2xl">
        ...
        <div className="p-6 border-t border-slate-800 bg-[#1e293b]">
          ...
          <button className="w-full py-4 bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled={carrito.length === 0}>
