export const fallbackStores = [
  { name: 'Exito', slug: 'exito', category: 'Supermercado', type: 'supermercado', branches: 120, description: 'Supermercado nacional con productos de mercado, hogar, tecnologia y farmacia.' },
  { name: 'Olimpica', slug: 'olimpica', category: 'Supermercado', type: 'supermercado', branches: 95, description: 'Cadena nacional de supermercados y droguerias con presencia en varias ciudades.' },
  { name: 'Jumbo', slug: 'jumbo', category: 'Supermercado', type: 'supermercado', branches: 42, description: 'Supermercado de gran formato con catalogo de mercado, frescos, hogar y cuidado personal.' },
  { name: 'Carulla', slug: 'carulla', category: 'Supermercado', type: 'supermercado', branches: 38, description: 'Supermercado premium con alimentos, productos importados y mercado diario.' },
  { name: 'D1', slug: 'd1', category: 'Supermercado', type: 'supermercado', branches: 80, description: 'Tienda de descuento con productos basicos de compra frecuente.' },
  { name: 'Ara', slug: 'ara', category: 'Supermercado', type: 'supermercado', branches: 72, description: 'Tienda de descuento con cobertura nacional y productos de alta rotacion.' },
  { name: 'Makro', slug: 'makro', category: 'Supermercado', type: 'supermercado', branches: 18, description: 'Comercio mayorista para mercado, hogar, negocios y abastecimiento.' },
